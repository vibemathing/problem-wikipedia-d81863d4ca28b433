...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-d81863d4ca28b433"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-d81863d4ca28b433",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-d81863d4ca28b433",
        "url": "https://en.wikipedia.org/wiki/Bipartite_graph"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Is it true that out of all bipartite graphs , crown graphs require longest word-representants?",
      "version": 1
    },
    "title": "Is it true that out of all bipartite graphs , crown graphs require longest word-representants?",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "4a4fcdaf288fc3d617ade84a4ee2b805c8035c08dd1114b92a0c503b65c0357a"
}
```
